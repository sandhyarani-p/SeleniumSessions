...
public class EnterValueInDisableTextField {
	...
	public static void main(String[] args) {
		...
		boolean flag = driver.findElement(By.id("pass")).isEnabled();// this will give false if disabled
		System.out.println(flag);

		boolean flag1 = driver.findElement(By.id("pass")).isDisplayed();// this will give true
